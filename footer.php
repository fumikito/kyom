...
$cache = get_transient( 'kyom_footer' );
if ( false !== $cache ) {
	echo $cache;
} else {
	ob_start();
	...
	<footer class="site-footer">
		...
		<div class="uk-container">
			...
			<p class="site-footer-copy">
				&copy; <?php echo esc_html( kyom_oldest_date() ); ?> <a href="<?php echo home_url(); ?>"
																		rel="home"><?php bloginfo( 'name' ); ?></a>
				| Powered by <a
					href="https://wordpress.org">WordPress <?php echo esc_html( $GLOBALS[ 'wp_version' ] ); ?></a> and
				<a href="https://github.com/fumikito/kyom">Kyom <?php echo kyom_version( true ); ?></a>.
			</p>
		</div>
	</footer>
	<?php
	...
	ob_end_flush();
	set_transient( 'kyom_footer', $footer, 36000 );
}
do_action( 'wp_footer' );
?>
</body>
